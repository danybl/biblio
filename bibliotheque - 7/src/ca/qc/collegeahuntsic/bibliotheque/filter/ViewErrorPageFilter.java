...
public class ViewErrorPageFilter implements Filter {
     ...
     * Does nothing.
     * 
     * @param unFilterConfig The ca.qc.collegeahuntsic.bibliotheque.filter configuration to use
     */
    @Override
     ...
     * @param chain The ca.qc.collegeahuntsic.bibliotheque.filter chain to use
