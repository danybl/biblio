...
/**
 * Cette exception est utilisée en cas de problème avec la classe d'un objet
 * {@link ca.qc.collegeahuntsic.bibliothequeBackEnd.dto.DTO}.
 * 
 */
public class InvalidDTOClassException extends Exception {
	 ...
	 *            cause is nonexistent or unknown
	 */
	public InvalidDTOClassException(String message, Throwable cause) {
		super(message, cause);
	}
