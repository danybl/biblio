...
/**
 * Cette exception est utilisée en cas de problème avec une propriété utilisée
 * pour classer une liste de DTOs.
 * 
 */
public class InvalidSortByPropertyException extends Exception {
	 ...
	 *            cause is nonexistent or unknown
	 */
	public InvalidSortByPropertyException(String message, Throwable cause) {
		super(message, cause);
	}
