...
public class PretService extends Service implements IPretService {
	 ...
	 */
	@Override
	public List<PretDTO> getAll(Session session, String sortByPropertyName)
	 ...
	 */
	@Override
	public void emprunter(Session session, PretDTO pretDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			...
			InvalidLoanLimitException, ServiceException {
		if (session == null) {
		...
		if (!reservations.isEmpty()) {
			throw new ExistingReservationException("Le livre "
					...
					+ unLivreDTO.getIdLivre() + ") a des réservations" + ")");
		}
		...
		pretDTO.getMembreDTO()
				.setNbPret(
						Integer.toString(Integer.parseInt(unMembreDTO
								.getNbPret()) + 1));
	 ...
	 */
	@Override
	public void retourner(Session session, PretDTO pretDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			InvalidDTOClassException, MissingDTOException,
			InvalidCriterionException, InvalidSortByPropertyException,
			ExistingLoanException, ExistingReservationException,
