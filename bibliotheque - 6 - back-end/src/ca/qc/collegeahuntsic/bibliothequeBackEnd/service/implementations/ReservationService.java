...
public class ReservationService extends Service implements IReservationService {
	...
	public void placer(Session session, ReservationDTO reservationDTO)
			...
			InvalidCriterionValueException, InvalidSortByPropertyException,
	...
	public void utiliser(Session session, ReservationDTO reservationDTO)
		...
		try {
			...
			reservationDTO.getLivreDTO().getReservations()
					.remove(reservationDTO);// TODO reviser
	...
	public void annuler(Session session, ReservationDTO reservationDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			MissingDTOException, InvalidDTOClassException, ServiceException {
		if (session == null) {
			throw new InvalidHibernateSessionException(
					"La session ne peut être null");
		}
