...
public interface IPretService extends IService {
    ...
    /**
     * Trouve tous les prêts de la base de données. La liste est classée par ordre croissant sur <code>sortByPropertyName</code>. Si
     * aucun prêt n'est trouvé, une {@link List} vide est retournée.
     *
     * @param connexion La connexion à utiliser
    ...
    /**
     * Trouve les prêts à partir d'un meembre. La liste est classée par ordre croissant sur <code>sortByPropertyName</code>. Si aucun
    ...
    /**
     * Trouve les prêts à partir d'un livre. La liste est classée par ordre croissant sur <code>sortByPropertyName</code>. Si aucun
     * prêt n'est trouvé, une {@link List} vide est retournée.
     *
     * @param connexion La connexion à utiliser
     ...
     * @throws ServiceException S'il y a une erreur avec la base de données
     */
    void emprunter(Connexion connexion,
        PretDTO pretDTO) throws InvalidHibernateSessionException,
        InvalidDTOException,
        InvalidDTOClassException,
        InvalidPrimaryKeyException,
