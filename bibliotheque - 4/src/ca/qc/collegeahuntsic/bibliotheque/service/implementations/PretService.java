...
public class PretService extends Service implements IPretService {
	 ...
	 */
	@Override
	public List<PretDTO> findByMembre(Connexion connexion, String idMembre,
	...
	@Override
	public List<PretDTO> findByLivre(Connexion connexion, String idLivre,
			String sortByPropertyName) throws InvalidHibernateSessionException,
			InvalidCriterionException, InvalidSortByPropertyException,
			ServiceException {
		try {
	...
	@Override
	public void emprunter(Connexion connexion, PretDTO pretDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
		...
		try {
			...
			if (prets != null) {
				...
				if (!unMembreDTO.equals(unPretDTO.getMembreDTO())) {
					MembreDTO booker = (MembreDTO) getMembreDAO().get(
							connexion, unPretDTO.getMembreDTO().getIdMembre());
			...
			nouveauPretDTO
					.setDatePret(new Timestamp(System.currentTimeMillis()));
			nouveauPretDTO.setDateRetour(null);
			getPretDAO().add(connexion, nouveauPretDTO);
		} catch (DAOException daoException) {
			throw new ServiceException(daoException);
		}
	}
	...
	public void renouveler(Connexion connexion, PretDTO pretDTO)
		...
		try {
			...
			if (prets != null) {
				...
				update(connexion, nouveauPretDTO);
			}
		} catch (DAOException daoException) {
			throw new ServiceException(daoException);
		}
	...
	@Override
	public void retourner(Connexion connexion, PretDTO pretDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			InvalidDTOClassException, InvalidPrimaryKeyException,
			MissingDTOException, InvalidCriterionException,
			InvalidSortByPropertyException, ExistingLoanException,
		...
		try {
			...
			PretDTO nouveauPretDTO = new PretDTO();
			delete(connexion, nouveauPretDTO);
		} catch (DAOException daoException) {
			throw new ServiceException(daoException);
		}
	}
